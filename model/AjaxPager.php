	...
	public function showPagination(){
		...
		if($this->_totalPage > 1){
			...
			if($this->_currentPage > 1){
				$start 	= "<li class='ajaxPage' page=1><a href='#'>Start</a></li>";
				$prev 	= "<li class='ajaxPage' page='".($this->_currentPage-1)."'><a href='#'><<</a></li>";
			}
			$next 	= '';
			$end 	= '';
			if($this->_currentPage < $this->_totalPage){
				$next 	= "<li class='ajaxPage' page='".($this->_currentPage+1)."'><a href='#'>>></a></li>";
				$end 	= "<li class='ajaxPage' page='".$this->_totalPage."'><a href='#'>End</a></li>";
			}
			...
			for($i = $startPage; $i <= $endPage; $i++){
				if($i == $this->_currentPage) {
					$listPages .= "<li class='active ajaxPage'><a href='#'>".$i.'</a>';
				}else{
					$listPages .= "<li class='ajaxPage' page='".$i."'><a href='#'>".$i.'</a>';
				}
			}
