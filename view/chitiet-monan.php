            ...
            <div class="product-image">
              <div class="product-featured-image">
                <div class="main-slider">
                  <div class="slides">
                    <div class="featured-image-item"><img src="public/assets/images/hinh_mon_an/<?=$food->image?>" alt="fooday" class="img img-responsive"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="product-summary">
              ...
              <div class="product-price">
                <div class="price"><?=$food->price?><span class="currency-symbol">vnđ</span></div>
              </div>
        ...
        <div class="swin-sc swin-sc-product products-02 carousel-01 woocommerce">
          ...
          <?php foreach($relatedFood as $same){?>
            <div class="blog-item item swin-transition">
              <div class="block-img"><img src="public/assets/images/hinh_mon_an/<?=$same->image?>" alt="" class="img img-responsive" style="height : 250px">
                <div class="block-circle price-wrapper"><span class="price woocommerce-Price-amount amount"><?=$same->price?><span class="price-symbol">vnd</span></span></div>
